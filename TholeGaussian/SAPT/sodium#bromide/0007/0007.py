...
psi4.core.set_output_file('0007.log', False)
...
with open("0007.out", "w") as result:
    result.write("    1\n")
    result.write(" Na 0.0 0.0 0.0\n")
    result.write("    1\n")
    result.write(" Br 0.0 0.0 2.5500000000000003\n")
